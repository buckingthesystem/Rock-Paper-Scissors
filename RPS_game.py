...
def game(variables):
	...
	#the while loop houses the if/elif/else logic for the game and is nested in an if statement to prevent the while loop from running after quiting the game. The number of wins are tabulated for the player and computer too.
	end = ''
	if end != var.quit:
		while end != var.quit:
